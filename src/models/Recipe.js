...
export function lateRecipe() {
  return types.model('Recipe', {
    not_location: types.maybeNull(types.string), // manual ref to location because circular dependency TODO: could this be changed to late? I think it gave me some problems.
