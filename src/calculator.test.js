...
describe('get_buildable_gear', () => {
  it('gets buildable correctly', () => {
    const owned_resources = {'white fur': 1, 'sinew': 1, 'lion claw': 2, 'lion testes': 1}
    expect(get_buildable_gear(owned_resources, ['catarium'], [], game_data)).toEqual(['white_lion_helm'])
  })
})
