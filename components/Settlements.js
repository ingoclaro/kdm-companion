...
export const SettlementSelector = inject(({ store }) => ({
  ...
  observer(
    class SettlementSelector extends React.Component {
      constructor(props) {
        super(props)
      }
...
export const EditSettlement = inject(({ store }) => ({
...
export const CreateSettlement = inject(({ store }) => ({
...
export const DeleteSettlement = inject(({ store }) => ({
  delete: store.deleteCampaign,
  campaign: store.selectedCampaign,
  numCampaigns: store.numCampaigns,
}))(
  observer(
    class DeleteSettlement extends React.Component {
      constructor(props) {
        super(props)
      ...
      render() {
        return (
          <View>
            ...
            <Text>
              This will delete all data associated with that Settlement.
            </Text>
            <Divider />
