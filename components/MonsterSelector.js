...
const MonsterSelector = inject(({ store }) => ({
...
export const HuntMonsterSelector = inject(({ store }) => ({
  selected: store.selectedCampaign.hunting,
  select: store.selectedCampaign.selectHunt,
}))(
  observer(
    class HuntMonsterSelector extends React.Component {
      render() {
...
export const ShowdownMonsterSelector = inject(({ store }) => ({
  selected: store.selectedCampaign.showdown,
  select: store.selectedCampaign.selectShowdown,
}))(
  observer(
    class ShowdownMonsterSelector extends React.Component {
      render() {
